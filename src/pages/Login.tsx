...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/configuration-not-found') {
        errorMessage = 'Błąd konfiguracji Firebase. Sprawdź czy domena jest autoryzowana w Firebase Console.';
      } else if (error.code === 'auth/popup-closed-by-user') {
        errorMessage = 'Logowanie anulowane.';
      } else if (error.code === 'auth/popup-blocked') {
        errorMessage = 'Popup został zablokowany przez przeglądarkę.';
      }
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="bg-background-secondary border border-border rounded-2xl p-8 shadow-xl">
          {/* Logo */}
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">Archiwum</h1>
